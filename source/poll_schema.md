...
</datatypes><table x="136" y="104" name="users">
...
<table x="304" y="103" name="polls">
  ...
  <table x="472" y="107" name="questions">
    <row name="id" null="1" autoincrement="1">
      <datatype>INTEGER</datatype>
      <default>NULL</default></row>
      ...
      <table x="304" y="271" name="vote">
        ...
        <table x="474" y="273" name="responses">
          <row name="id" null="1" autoincrement="1">
            <datatype>INTEGER</datatype>
            <default>NULL</default></row>
